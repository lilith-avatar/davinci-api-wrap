...
Enum.KeyCode = {
    ...
    Delete = 127,
    --KEY_Enum.KeyCode.Delete
    Keypad0 = 256,
    --KEY_Enum.KeyCode.Keypad0
    Keypad1 = 257,
    --KEY_Enum.KeyCode.Keypad1
    Keypad2 = 258,
    --KEY_Enum.KeyCode.Keypad2
    Keypad3 = 259,
    --KEY_Enum.KeyCode.Keypad3
    Keypad4 = 260,
    --KEY_Enum.KeyCode.Keypad4
    Keypad5 = 261,
    --KEY_Enum.KeyCode.Keypad5
    Keypad6 = 262,
    --KEY_Enum.KeyCode.Keypad6
    Keypad7 = 263,
    --KEY_Enum.KeyCode.Keypad7
    Keypad8 = 264,
    --KEY_Enum.KeyCode.Keypad8
    Keypad9 = 265,
    --KEY_Enum.KeyCode.Keypad9
    ...
    LeftControl = 306,
    --KEY_Enum.KeyCode.LeftControl
    RightAlt = 307,
    --KEY_Enum.KeyCode.RightAlt
    ...
    AltGr = 313,
    --KEY_Enum.KeyCode.AltGr
    Help = 315,
    --KEY_Enum.KeyCode.Help
    Print = 316,
    --KEY_Enum.KeyCode.Print
    SysReq = 317,
    --KEY_Enum.KeyCode.SysReq
    Break = 318,
    --KEY_Enum.KeyCode.Break
    Menu = 319,
    --	KEY_Enum.KeyCode.Menu
    Mouse0 = 323,
    --KEY_Enum.KeyCode.Mouse0
    Mouse1 = 324,
    --KEY_Enum.KeyCode.Mouse1
    Mouse2 = 325,
    --KEY_Enum.KeyCode.Mouse2
    Mouse3 = 326
    --KEY_Enum.KeyCode.Mouse3
}
...
---@class Enum.NavMeshPathStatus
Enum.NavMeshPathStatu = {
    PathSuccess = 1, --寻路成功
    ClosestNoPath = 2,
    ClosestOutOfRange = 3, --目标点太远，返回部分路径
    FailStart = 4,
     --起点不在导航网格上，寻路失败
    FailEnd = 5, --终点不在导航网格上，寻路失败
    NoPath = 6, -- 未找到路径，寻路失败
    FailOutOfTime = 7 --寻路超时
}
